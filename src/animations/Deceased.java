...
//	private static final String imagePath = "redacted/resources/deceased_animation_x4.png";
    ...
    public Rectangle2D getIdleFront() {
    	return deceasedIdleFront;
    }

    public Rectangle2D getIdleBack() {
    	return deceasedIdleBack;
    }
